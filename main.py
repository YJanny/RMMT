...
if __name__ == '__main__':
    ...
    parser.add_argument('-experiment_name', default="VtE_KD_fusionEEGnolocal", help='The experiment name.')
    ...
    parser.add_argument('-high_performance_cluster', default=1, type=int, help='On high-performance server or not? Such as Colab where you cannot specify GPU freely.') # Specify this
    ...
    parser.add_argument('-case', default='trs', type=str, help='trs: trial-wise shuffling, loso.: leave-one-subject-out.') # Specify this

    parser.add_argument('-debug', default=1, type=str, help='When debug=1, only fold x 1 trials would be loaded. And the epoch is set to 1 for a quick run-over.') # Specify this
    ...
    parser.add_argument('-dataset_path', default='D:/projects/data/Mahnob/mahnob_pr_processed', type=str,
                        help='The root directory of the dataset.') # Specify this
    parser.add_argument('-dataset_folder', default='compacted_48', type=str,
                        help='The root directory of the dataset.') # Specify this
    parser.add_argument('-load_path', default='D:/projects/physiological signal/aafacewitheeg/Visual_to_EEG_Cross_Modal_KD_for_CER-main/load', type=str, help='The path to load the backbones.') # Specify this
    parser.add_argument('-save_path', default='D:/projects/physiological signal/aafacewitheeg/Visual_to_EEG_Cross_Modal_KD_for_CER-main/save', type=str, help='The path to save the trained models ') # Specify this
    parser.add_argument('-python_package_path', default='D:/projects/physiological signal/aafacewitheeg/Visual_to_EEG_Cross_Modal_KD_for_CER-main', type=str, help='The path to the entire repository.') # Specify this
    ...
    parser.add_argument('-lstm_embedding_dim', default=64, type=int, help='64Dimensions for LSTM feature vectors.')
    parser.add_argument('-lstm_hidden_dim', default=64, type=int, help='64The size of the 1D kernel for temporal convolutional networks.')
    ...
    # parser.add_argument('-metrics', default=["acc"], nargs="*", help='The evaluation metrics.')
